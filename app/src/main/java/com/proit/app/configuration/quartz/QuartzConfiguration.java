...
import com.proit.app.configuration.properties.QuartzProperties;
...
public class QuartzConfiguration
{
	...
	public SchedulerFactoryBean schedulerFactoryBean(DataSource dataSource, PlatformTransactionManager transactionManager, JobFactory jobFactory) throws IOException
	{
		...
		{
			properties.put("org.quartz.threadPool.class", "com.proit.app.configuration.quartz.ZeroSizeThreadPool");
		}
