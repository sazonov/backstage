...
// TODO: 31.08.2023 Актуально ли? используется для теха апи-сервиса в ЦАФАП. Но не понятно, актуально ли
public class SystemdConfiguration
{
	/**
	 * @return возвращает информацию о загруженных конфигах
	 */
	@Bean
	...
	/**
	 * @return возвращает информацию о версии билда
	 */
	@Bean
