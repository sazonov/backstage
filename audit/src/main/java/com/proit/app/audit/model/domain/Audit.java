...
package com.proit.app.audit.model.domain;

import com.proit.app.audit.conversion.jpa.AuditPropertiesConverter;
...
@Setter
@Entity
@Table(name = "audit", schema = "#{@auditProperties.ddl.scheme}")
