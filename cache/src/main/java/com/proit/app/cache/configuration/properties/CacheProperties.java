...
package com.proit.app.cache.configuration.properties;
...
public class CacheProperties
{
	...
	public enum DistributedCacheOperation
	{
		EVICT,
		ANY
	}

	private Map<String, Set<DistributedCacheOperation>> distributedOperations = new HashMap<>();
}
