...
{
	ReportTask getById(String id);

	ReportTask create(String userId, ReportFilter reportFilter, String reportFileName);

	ReportTask complete(String id, ReportStatus reportStatus, String reportId);

	List<ReportTask> getGeneratingReportTasks();
}
