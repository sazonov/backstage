 ...
 * Провайдер должен быть выполнен раньше {@link StorageMigrationDictsDDLProvider}, по причине наличия обьектов
...
public class StorageDictsDDLProvider implements DictsStorageDDLProvider, BeanNameAware
{
