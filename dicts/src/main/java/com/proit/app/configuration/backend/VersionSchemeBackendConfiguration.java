...
package com.proit.app.configuration.backend;
...
public class VersionSchemeBackendConfiguration extends AbstractDictConfiguration<VersionSchemeBackend>
{
	public VersionSchemeBackendConfiguration(DictsProperties dictsProperties, List<VersionSchemeBackend> backends)
	{
		super(dictsProperties, backends);
	}

	@Primary
	@Bean(name = "versionSchemeBackend")
	protected VersionSchemeBackend primaryBackend()
	{
