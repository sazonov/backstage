...
public class DictBackendConfiguration extends AbstractDictConfiguration<DictBackend>
{
	public DictBackendConfiguration(DictsProperties dictsProperties, List<DictBackend> backends)
	{
		super(dictsProperties, backends);
	}

	@Primary
	@Bean(name = "dictBackend")
	protected DictBackend primaryBackend()
	{
