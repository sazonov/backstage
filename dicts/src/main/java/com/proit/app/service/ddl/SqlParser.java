...
public class SqlParser
{
	...
	final Parser<RenameTableOperation> RENAME_TABLE_EXPR = phrase("rename", "to").next(ID_WITH_NAME).map(RenameTableOperation::new);
	...
	final Parser<Expression> ALTER_TABLE_EXPR = Parsers.sequence(
			...
			Parsers.or(
					...
					RENAME_TABLE_EXPR, RENAME_COLUMN_EXPR, ADD_TABLE_CONSTRAINT_EXPR, DROP_TABLE_CONSTRAINT_EXPR,
