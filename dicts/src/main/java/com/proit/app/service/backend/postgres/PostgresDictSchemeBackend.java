...
import com.proit.app.exception.dict.*;
import com.proit.app.exception.dict.constraint.ConstraintCreatedException;
import com.proit.app.exception.dict.constraint.ConstraintDeletedException;
import com.proit.app.exception.dict.field.FieldUpdatedException;
import com.proit.app.exception.dict.index.IndexCreatedException;
import com.proit.app.exception.dict.index.IndexDeletedException;
...
public class PostgresDictSchemeBackend extends AbstractPostgresBackend implements DictSchemeBackend
{
	...
	private Dict createdDictScheme(Dict dict)
	{
		...
		fieldsDefinition.add("primary key (%s)".formatted(ID));
