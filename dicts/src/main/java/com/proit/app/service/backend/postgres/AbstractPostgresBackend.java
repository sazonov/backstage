...
import com.proit.app.exception.BiFunctionException;
import com.proit.app.exception.TriFunctionException;
...
public abstract class AbstractPostgresBackend
{
	...
	protected void addTransactionData(String dictId, boolean schemeUsed)
	{
		dictTransactionProvider.addDictTransactionItem(
				DictTransactionItem.of(dictId, null, postgresEngine.getDictEngine(), schemeUsed));
	}
